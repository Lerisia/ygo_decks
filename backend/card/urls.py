...
urlpatterns = [
    ...
    path("search/", search_cards_by_name, name="search_cards_by_name"),
    ...
    path("admin/effect-tags/", effect_tags_list, name="effect_tags_list"),
    path("admin/effect-tags/<int:card_pk>/", effect_tag_update, name="effect_tag_update"),
]
